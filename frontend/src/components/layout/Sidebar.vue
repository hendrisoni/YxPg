<template>
  <aside
    class="h-full bg-navy-secondary border-r border-navy-border flex flex-row"
    :class="{ 'transition-[width] duration-150': !uiStore.isResizingSidebar }"
    :style="{ width: sidebarWidth + 'px' }"
  >
    <!-- Left Toolbar (VS Code-like Activity Bar) -->
    <div class="w-12 bg-[#090d16] border-r border-navy-border flex flex-col items-center py-4 justify-between flex-shrink-0">
      <!-- Top Icons -->
